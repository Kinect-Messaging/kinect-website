export default function FeaturesPageBlocks() {
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-15 md:py-20" style={{ paddingTop: '130px' }}>
          ...
          <div className="relative max-w-sm mx-auto grid gap-16 md:grid-cols-2 lg:grid-cols-3 lg:gap-y-20 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="200">
              ...
              <h3 className="h4 font-playfair-display mb-2">Customer Journey Creation</h3>
              <p className="text-lg text-slate-500">
                Craft every touch-point, identify opportunities, and personalize every interaction.
              </p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h3 className="h4 font-playfair-display mb-2">Template Creation</h3>
              <p className="text-lg text-slate-500">
                Create your messaging template with elegance and efficiency using our intuitive features.
              </p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="100">
              ...
              <h3 className="h4 font-playfair-display mb-2">Template Management</h3>
              <p className="text-lg text-slate-500">
                Easily save, store, and query your messaging templates in our repository.
              </p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="200">
              ...
              <h3 className="h4 font-playfair-display mb-2">Email Delivery</h3>
              <p className="text-lg text-slate-500">
                Precise delivery sending the right message, to the right Customer, at the right time.
              </p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="300">
              ...
              <h3 className="h4 font-playfair-display mb-2">Scheduled Delivery</h3>
              <p className="text-lg text-slate-500">
                Establish delivery schedules based on capacity, preferences, and engagement patterns.
              </p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="400">
              ...
              <h3 className="h4 font-playfair-display mb-2">Ad-hoc / event-triggered</h3>
              <p className="text-lg text-slate-500">
                One-time or ongoing messaging delivery that is tailored to your campaign strategy and objectives.
              </p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="500">
              ...
              <h3 className="h4 font-playfair-display mb-2">Data Retention</h3>
              <p className="text-lg text-slate-500">
                Data will be retained and stored based on your specific expectations and policies.
              </p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="500">
              ...
              <h3 className="h4 font-playfair-display mb-2">Data privacy & protection</h3>
              <p className="text-lg text-slate-500">
                Data will be safe, secure, and accessible while complying with privacy and data protection laws.
              </p>
            </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]" data-aos-delay="500">
              ...
              <h3 className="h4 font-playfair-display mb-2">Data & Dashboards</h3>
              <p className="text-lg text-slate-500">
                Visualize and analyze performance data to drive insights, action, and value for your business objectives.
              </p>
            </div>
