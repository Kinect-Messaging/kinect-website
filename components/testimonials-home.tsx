          ...
          <div className="max-w-sm mx-auto md:max-w-none grid gap-12 md:grid-cols-3 md:gap-x-10 md:gap-y-10 items-start">
            ...
            <article data-aos="fade-up">
              ...
              <h3 className="h4 font-playfair-display mb-2">
                <a className="text-slate-800 hover:underline hover:decoration-blue-100" href="#0">"A huge difference"</a>
              </h3>
              <p className="text-lg text-slate-600">
                "We appreciate the time that Kinect took to understand our issues, where we’re at today and suggest smart creative solutions. They took the time to learn our business and our goals. That made a huge difference."
              </p>
              <p className="text-lg text-slate-600">
                ~ Jack
              </p>
              <p className="text-lg text-slate-600">
                Executive Director, KidVantage
              </p>
            </article>
