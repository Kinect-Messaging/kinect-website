    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-slate-200">
          ...
          {/* Section header */}
          <div className="max-w mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-playfair-display text-slate-800 mb-3">Kinect Messaging provides a holistic approach to enable organizations to sustain and realize value immediately</h2>
                ...
                <li>
                  <div className="flex items-center mb-4">
                    ...
                    <div className="text-slate-500 text-xl">
                      <div>Aligning business strategies with technology capabilities to <span style={{ fontWeight: 'bold' }}>maximize ROI and efficiency</span>.</div>
                    </div>
                  </div>
                </li>
                <li>
                  <div className="flex items-center mb-4">
                    ...
                    <div className="text-slate-500 text-xl">
                      <div>Technology integration with business processes, testing, and training to <span style={{ fontWeight: 'bold' }}>maximize feature utilization</span>.</div>
                    </div>
                  </div>
                </li>
                <li>
                  <div className="flex items-center mb-4">
                    ...
                    <div className="text-slate-500 text-xl">
                      <div>Self serve documentation and resources to <span style={{ fontWeight: 'bold' }}>minimize</span> unnecessary time spent searching information.</div>
                    </div>
                  </div>
                </li>
              </ul>
