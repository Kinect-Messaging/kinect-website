            ...
            <div className="w-full max-w-md mx-auto">
              ...
              <form>
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium mb-1" htmlFor="country">Purpose <span className="text-rose-500">*</span></label>
                    <InputLabel id="demo-multiple-chip-label">Purpose of Inquiry</InputLabel>
        ...
        <div className="min-h-screen h-full flex flex-col justify-center">
          <div className="px-5 sm:px-6">
            ...
            <div className="w-full max-w-lg mx-auto">
              ...
              <h2 className="h3 md:text-5xl font-playfair-display text-slate-100 mb-4">Captivate.</h2>
            </div>
          </div>
        </div>
      </div>
